...
#ifndef _navier_stokes_ida_h
#define _navier_stokes_ida_h
...
template<int dim>
class NavierStokes : public SundialsInterface<VEC>, public ParameterAcceptor
{
public:

  NavierStokes (const MPI_Comm &comm);
      ...
      if (do_solve_A == true)
        {
          ...
          solver.solve(navier_stokes_matrix->block(0,0), dst.block(0), utmp,
                       a_preconditioner);
        }
      else
