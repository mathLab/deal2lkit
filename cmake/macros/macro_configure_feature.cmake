...
MACRO(CONFIGURE_FEATURE _feature)
  ...
  #
  IF( (NOT D2K_ALLOW_AUTODETECTION) AND
      (NOT DEFINED D2K_WITH_${_feature}) )
  ...
  IF((NOT DEFINED D2K_WITH_${_feature}) OR
    ...
    IF(_dependencies_ok)
      IF(D2K_FORCE_BUNDLED_${_feature})
        #
        # First case: D2K_FORCE_BUNDLED_${_feature} is defined:
        #
        ...
        ELSE()
          MESSAGE(FATAL_ERROR "\n"
            "Internal build system error: D2K_FORCE_BUNDLED_${_feature} "
            "defined, but FEATURE_${_feature}_HAVE_BUNDLED not present.\n"
            )
        ENDIF()

      ELSE(D2K_FORCE_BUNDLED_${_feature})
        #
