...
#
# This file implements the D2K_INVOKE_AUTOPILOT macro, which is
# part of the deal.II library.
#
# Usage:
#       D2K_INVOKE_AUTOPILOT()
#
...
MACRO(D2K_INVOKE_AUTOPILOT)
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "(CYGWIN|Windows)")
    ...
    FILE(WRITE ${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/run_target.cmake
      "SET(ENV{PATH} \"${CMAKE_CURRENT_BINARY_DIR}${_delim}${D2K_PATH}/${D2K_EXECUTABLE_RELDIR}${_delim}\$ENV{PATH}\")\n"
  ...
  # switch between them:
  IF(${D2K_BUILD_TYPE} MATCHES "DebugRelease")
    SET(_switch_targets
...
\"###
#
#  Project  ${TARGET}  set up with  ${D2K_PACKAGE_NAME}-${D2K_PACKAGE_VERSION}  found at
#      ${D2K_PATH}
#
