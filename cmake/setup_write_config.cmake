...
IF(NOT D2K_SETUP_DEFAULT_COMPILER_FLAGS)
  _both("#  WARNING: D2K_SETUP_DEFAULT_COMPILER_FLAGS is set to OFF\n")
ENDIF()
_both("#  Configured Features (")
IF(DEFINED D2K_ALLOW_BUNDLED)
  _both("D2K_ALLOW_BUNDLED = ${D2K_ALLOW_BUNDLED}, ")
ENDIF()
IF(D2K_FORCE_AUTODETECTION)
  _both("!!! D2K_FORCE_AUTODETECTION=ON !!!, ")
ENDIF()
_both("D2K_ALLOW_AUTODETECTION = ${D2K_ALLOW_AUTODETECTION}):\n")
