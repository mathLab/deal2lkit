           ...
           const FiniteElement<dim> &fe)
{
  ...
  DOFUtilities::get_laplacians(fe_values, independent_local_dof_values, vector, vector_laplacians);
  DOFUtilities::get_hessians(fe_values, independent_local_dof_values, scalar, scalar_hessians);
  DOFUtilities::get_hessians(fe_values, independent_local_dof_values, vector, vector_hessians);
  DOFUtilities::get_curls(fe_values, independent_local_dof_values, vector, curls);
...
void test_hyper_cube()
{
  ...
  FESystem<dim> fe2 (FE_Q<dim>(2), dim,
                     FE_Q<dim>(1), 1);
