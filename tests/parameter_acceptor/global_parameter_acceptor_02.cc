...
main()
{
  ...
  TemplateClass<std::vector<std::vector<std::string>>> f110(
    std::vector<std::vector<std::string>>(2,
                                          std::vector<std::string>(3, "ciao")),
    "std::vector<std::vector<std::string>>");
  TemplateClass<std::vector<std::vector<int>>> f111(
    std::vector<std::vector<int>>(2, std::vector<int>(3, -1)),
    "std::vector<std::vector<int>>");
  TemplateClass<std::vector<std::vector<unsigned int>>> f112(
    std::vector<std::vector<unsigned int>>(2, std::vector<unsigned int>(3, 1)),
    "std::vector<std::vector<unsigned int>>");
  TemplateClass<std::vector<std::vector<double>>> f113(
    std::vector<std::vector<double>>(2, std::vector<double>(3, 1e-4)),
    "std::vector<std::vector<double>>");

  std::system("rm -f parameters.prm");
  // The first round is here to create the file parameters.prm with default
  // values
