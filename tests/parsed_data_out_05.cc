...
Test<dim, spacedim>::Test ()
  ...
  data_out("Data out","vtk",1,"run/out","output", "parameters_new.prm % used_parameters_new.prm")
{}
...
int main (int argc, char *argv[])
{
  ...
  Test<dim, spacedim> test;
  test.run();
  deallog << "Exist ./run/out001/parameters_new.prm =" << file_exists("./run/out001/parameters_new.prm") << std::endl;
  deallog << "Exist ./run/out001/used_parameters_new.prm =" << file_exists("./run/out001/used_parameters_new.prm") << std::endl;
  return 0;
}
