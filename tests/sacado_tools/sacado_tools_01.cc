...
void test(const Triangulation<dim> &tr, const FiniteElement<dim> &fe)
{
  ...
  std::vector<Tensor<1, dim, SSdouble>> vector_values_ssdouble(
    quadrature.size());
  ...
  for (unsigned int q = 0; q < quadrature.size(); ++q)
    {
      ...
      res_sdouble[q] =
        SacadoTools::scalar_product(grad_s_double[q], grad_s_sdouble[q]);
      deallog << res_sdouble[q] << std::endl;
      res_ssdouble[q] =
        SacadoTools::scalar_product(grad_s_ssdouble[q], grad_s_double[q]);
  ...
  for (unsigned int q = 0; q < quadrature.size(); ++q)
    {
      ...
      deallog << res_double[q] << std::endl;
      res_sdouble[q] = SacadoTools::scalar_product(vector_values_double[q],
                                                   vector_values_sdouble[q]);
      deallog << res_sdouble[q] << std::endl;
      res_ssdouble[q] = SacadoTools::scalar_product(vector_values_ssdouble[q],
                                                    vector_values_double[q]);
      deallog << res_ssdouble[q] << std::endl;
      deallog << res_double[q] - res_sdouble[q].val() << std::endl;
      deallog << res_double[q] - res_ssdouble[q].val().val() << std::endl;
    }
  ...
  for (unsigned int q = 0; q < quadrature.size(); ++q)
    {
      ...
      deallog << res_double[q] << std::endl;
      res_sdouble[q] =
        SacadoTools::scalar_product(grad_v_sdouble[q], grad_v_double[q]);
      deallog << res_sdouble[q] << std::endl;
      res_ssdouble[q] =
        SacadoTools::scalar_product(grad_v_double[q], grad_v_ssdouble[q]);
      deallog << res_ssdouble[q] << std::endl;
      deallog << res_double[q] - res_sdouble[q].val() << std::endl;
      deallog << res_double[q] - res_ssdouble[q].val().val() << std::endl;
    }
  ...
  for (unsigned int q = 0; q < quadrature.size(); ++q)
    {
      res_double[q] =
        scalar_product(sym_grad_v_double[q], sym_grad_v_double[q]);
      deallog << res_double[q] << std::endl;
      res_sdouble[q] = SacadoTools::scalar_product(sym_grad_v_sdouble[q],
                                                   sym_grad_v_double[q]);
      deallog << res_sdouble[q] << std::endl;
      res_ssdouble[q] = SacadoTools::scalar_product(sym_grad_v_double[q],
                                                    sym_grad_v_ssdouble[q]);
      deallog << res_ssdouble[q] << std::endl;
      deallog << res_double[q] - res_sdouble[q].val() << std::endl;
      deallog << res_double[q] - res_ssdouble[q].val().val() << std::endl;
    }
  ...
  for (unsigned int q = 0; q < quadrature.size(); ++q)
    {
      res_double[q] = SacadoTools::scalar_product(vector_values_double[q],
                                                  vector_values_double[q]);
      res_double[q] =
        SacadoTools::scalar_product(grad_v_double[q], grad_v_double[q]);
    }
}
