...
int main()
{
  ...
  ParsedGridGenerator<2, 2> c("Hyper Shell",
                              "hyper_shell",
                              "",
                              "",
                              "",
  ...
  ParsedGridGenerator<3, 3> e("Hyper Cube with Cylindrical Hole",
  ...
  ParsedGridGenerator<2, 2> n("Half Hyper Shell",
                              "half_hyper_shell",
                              "",
                              "",
                              "",
  ...
  ParsedGridGenerator<3, 3> p("Cylinder Shell",
                              "cylinder_shell",
                              "",
                              "",
                              "",
  ...
  ParsedGridGenerator<2, 2> s("Cheese",
                              "cheese",
                              "",
                              "",
                              "",
