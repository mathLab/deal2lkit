...
ParsedAMGMueLuPreconditioner::ParsedAMGMueLuPreconditioner( const std::string &name,
                                                            const bool &elliptic,
...
void ParsedAMGMueLuPreconditioner::initialize_preconditioner( const Matrix &matrix)
{
...
template void deal2lkit::ParsedAMGMueLuPreconditioner::initialize_preconditioner<1,1,dealii::TrilinosWrappers::SparseMatrix>(
  const dealii::TrilinosWrappers::SparseMatrix &,
  const ParsedFiniteElement<1,1> &,
  const DoFHandler<1,1> &);
template void deal2lkit::ParsedAMGMueLuPreconditioner::initialize_preconditioner<2,2,dealii::TrilinosWrappers::SparseMatrix>(
  const dealii::TrilinosWrappers::SparseMatrix &,
  const ParsedFiniteElement<2,2> &,
  const DoFHandler<2,2> &);
template void deal2lkit::ParsedAMGMueLuPreconditioner::initialize_preconditioner<3,3,dealii::TrilinosWrappers::SparseMatrix>(
  const dealii::TrilinosWrappers::SparseMatrix &,
  const ParsedFiniteElement<3,3> &,
  const DoFHandler<3,3> &);

template void deal2lkit::ParsedAMGMueLuPreconditioner::initialize_preconditioner<dealii::TrilinosWrappers::SparseMatrix>(
  const dealii::TrilinosWrappers::SparseMatrix &);
