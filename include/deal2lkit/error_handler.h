  ...
  if (compute_error)
    {
      ...
      for (unsigned int component = 0; component < exact.n_components;
           ++component)
        {
          ...
          if (add_this)
            {
              ...
              error[last_non_add][2] =
                std::max(error[last_non_add][2], W1inf_error);
              ...
              if (norm & Linfty)
                {
                  ...
                  std::string latex_name = "$\\| " + latex_headers[j] + " - " +
                                           latex_headers[j] +
                                           "_h \\|_\\infty $";
